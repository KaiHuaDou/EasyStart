...
namespace StartPro
{
    public static class Default
    {
        ...
        public static SolidColorBrush Background => new SolidColorBrush(Color.FromArgb(255, 0xEF, 0xEF, 0xEF));
        public static SolidColorBrush Foreground => (SolidColorBrush) App.Current.Resources["Foreground"];
        public static Color ColorAdj => Color.FromRgb(30, 30, 30);
